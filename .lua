...
local UIS = game:GetService("UserInputService")-- Made By Kien Tuong
local WorldToViewportPoint = CurrentCam.WorldToViewportPoint
local mouseLocation = UIS.GetMouseLocation

game:GetService("StarterGui"):SetCore("SendNotification", {Title = "MADE BY KIEN TUONG", Text = "Kien tuong script blox fruit !"})

local DeleteMob ={
    GUi = {
        OpenNCloseButton = true; -- Have A Button For It
        KeybindEnable = true; -- If You Want A Bind For The Menu
        Keybind = "e"; -- Menu Key Bind
    };
	Aimbot= {
...
-- Made By DO TAN DAT X KIEN TUONG
...
local function AddTracers(Player) -- Tracers Without Lib OMG !!!!
	...
	coroutine.resume(co)-- Made By TUONG KIEN
end
...
local OTC = Instance.new("TextButton")-- LKT
...
local Tracers_B = Instance.new("TextBox")-- LKT
...
TextBox.PlaceholderText = "LOP 10A1 VA3 LKT"
TextBox.Text = "LKT 10A1 - VIETNAM COUNTRY"
...
Name.Text = "10A1 | MADE BY KIEN TUONG"
